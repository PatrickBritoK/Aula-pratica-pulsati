      ...
      if (pergunta == 1) {
            ...
            (codigoAeroporto) => {
              readline.question("Qual o endereço? ", (endereco) => {
                ...
                console.log(aeroportolist);
                  ...
                  promessas.push(salvarArquivo('aeroporto.txt','Cadastro feito com sucesso' ,
                  Aeroporto.getAeroporto()));
                  Promise.all(promessas).then(() => console.log('\nCadastro feito com sucesso'));
                menu();
              });
            });
        });
                  ...
                  readline.question(
                    ...
                    (nomeDaEmpresa) => {
                      ...
                      console.log(
                        ...
                        let Voo = new voo()
                        promessas.push(salvarArquivo('voo.txt','Cadastro feito com sucesso' ,
                        Voo.getVoo()));
                        Promise.all(promessas).then(() => console.log('\nCadastro feito com sucesso'));
                      menu();
                    });
        ...
        readline.question("Qual o codigo do voo? ", (codigoVoo) => {
          readline.question(
            ...
            (nomePassageiro) => {
              readline.question("Qual o nome do Aeroporto destino? ", destino => {
              passageirolist.push(codigoVoo, nomePassageiro, destino);
              console.log(passageirolist);
              let Passageiro = new passageiro()
              promessas.push(salvarArquivo('passageiro.txt', 'Cadastro feito com sucesso',
        ...
        console.log('codigo do voo: ',voolist[0],
                    '\nnome do aeroporto: ', aeroportolist[0],
                    '\nnome do aeroporto destino: ',passageirolist[2],
                    '\nnome dos passageiros no voo: ',passageirolist[1]);
      } else if(pergunta == 5){
        readline.close()
      }
    });
